"""
Test script for Super Admin Dashboard

This script generates a JWT token for a super admin user and opens the dashboard
in a PyQt6 window for testing purposes.

Usage:
    python test_dashboard_superadmin.py
"""
...
# Super Admin user credentials (for testing)
SUPERADMIN_USER_ID = 1
SUPERADMIN_USERNAME = "test_superadmin"
SUPERADMIN_ROLE = "super-admin"  # Note: 'super-admin' not 'superadmin'
...
def construct_dashboard_url(dashboard_type='superadmin', user_id=None, username=None, role=None, admin_id=None):
    """
...
def main():
    """Main function to test super admin dashboard."""
    print("=" * 60)
    print("Super Admin Dashboard Test Script")
    print("=" * 60)
    print()
    ...
    try:
        url, token, device_id = construct_dashboard_url(
            ...
            admin_id=None  # Super admin doesn't belong to an admin
        )
        ...
        if response == 'y' or response == 'yes':
            ...
            open_dashboard_window(url, "Super Admin Dashboard")
