...
import { useActiveUsers } from '@/hooks/useDashboardData';
...
export function ActiveUsersChart() {
  const { data: activeUsers, isLoading, refetch, isFetching } = useActiveUsers();
    ...
    <Card className="glass-card shadow-sm h-full flex flex-col">
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        <div>
          ...
          <CardDescription>Users generating the most traffic across sessions</CardDescription>
        </div>
        <Button 
          variant="outline" 
          size="icon" 
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip
                ...
                formatter={(value: number) => [`${value} Records`, 'Total Activity']}
              ...
              >
                {activeUsers.map((entry: any, index: number) => (
