"""
Automated Test execution for TEACHER dashboard
...
Usage:
  ...
  2. python tests/test_teacher_dashboard.py                 (run this test)
"""
import sys
import os

# Point dashboard at local dev server instead of production
os.environ["DASHBOARD_URL"] = "https://abhinavpaudel.com"
...
def main():
    ...
    username = "abhinavteacher1"
    password = "abhinavteacher123!"
